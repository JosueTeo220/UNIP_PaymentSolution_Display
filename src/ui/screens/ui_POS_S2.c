...
void ui_POS_S2_screen_init(void)
{
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_1, 10);
    lv_obj_set_y(ui_IMG_S2_Bg_1, -18);
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_2, 18);
    lv_obj_set_y(ui_IMG_S2_Bg_2, 28);
    ...
    lv_obj_set_x(ui_Label_Enter_Amount, 3);
    lv_obj_set_y(ui_Label_Enter_Amount, 1);
    lv_obj_set_align(ui_Label_Enter_Amount, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_Label_Enter_Amount, "Valor Total");
    ...
    lv_obj_set_x(ui_Label_Want_to_pay, 6);
    lv_obj_set_y(ui_Label_Want_to_pay, 23);
    lv_obj_set_align(ui_Label_Want_to_pay, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_Label_Want_to_pay, "Valor Total que quer Pagar");
    ...
    lv_obj_set_width(ui_Panel_Amount, lv_pct(84));
    lv_obj_set_x(ui_Panel_Amount, 1);
    lv_obj_set_y(ui_Panel_Amount, 41);
    ...
    lv_textarea_set_placeholder_text(ui_TextArea1, "100.00");
    ...
    lv_label_set_text(ui_Label_Amount_1, "Total");
    ...
    lv_obj_set_x(ui_Label_Amount_Pirce, -67);
    ...
    lv_obj_set_width(ui_BTN_Continue, 154);
    lv_obj_set_height(ui_BTN_Continue, 42);
    lv_obj_set_x(ui_BTN_Continue, 0);
    lv_obj_set_y(ui_BTN_Continue, 117);
    ...
    lv_obj_set_height(ui_Keyboard1, 216);
