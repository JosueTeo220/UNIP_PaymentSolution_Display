...
void ui_POS_S5_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Label_Succesful, -3);
    lv_obj_set_y(ui_Label_Succesful, -263);
    lv_obj_set_align(ui_Label_Succesful, LV_ALIGN_BOTTOM_MID);
    lv_label_set_text(ui_Label_Succesful, "Pagamento Completo");
    ...
    lv_obj_set_y(ui_Label_press_contimue, -90);
    lv_obj_set_align(ui_Label_press_contimue, LV_ALIGN_BOTTOM_MID);
    lv_label_set_text(ui_Label_press_contimue, "Precione para continuar");
