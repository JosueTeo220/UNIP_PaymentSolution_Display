...
void ui_POS_S1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Label_card_and_crypto, 2);
    lv_obj_set_y(ui_Label_card_and_crypto, -271);
    ...
    lv_obj_set_style_text_font(ui_Label_card_and_crypto, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(ui_Label_Lets_get, -86);
    ...
    lv_obj_set_x(ui_BTN_Next, -3);
    lv_obj_set_y(ui_BTN_Next, -10);
