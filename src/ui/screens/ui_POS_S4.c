...
void ui_POS_S4_screen_init(void)
{
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_5, -13);
    lv_obj_set_y(ui_IMG_S2_Bg_5, -19);
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_6, 8);
    lv_obj_set_y(ui_IMG_S2_Bg_6, 102);
    ...
    lv_obj_set_x(ui_Label_QR_ready, 3);
    lv_obj_set_y(ui_Label_QR_ready, 23);
    lv_obj_set_align(ui_Label_QR_ready, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_Label_QR_ready, "QR code pronto para escanear");
    ...
    lv_obj_set_y(ui_IMG_QR_Code, -14);
    ...
    lv_img_set_zoom(ui_IMG_QR_Code, 200);
    ...
    ui_ipAddress = lv_label_create(ui_POS_S4);
    lv_obj_set_width(ui_ipAddress, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ipAddress, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_ipAddress, 10);
    lv_obj_set_y(ui_ipAddress, -46);
    lv_obj_set_align(ui_ipAddress, LV_ALIGN_BOTTOM_MID);
    lv_label_set_text(ui_ipAddress, "ip_address");
    lv_obj_set_style_text_color(ui_ipAddress, lv_color_hex(0x7F848F), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_ipAddress, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_ipAddress, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_ipAddress, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Label_Cancel, 2);
    lv_obj_set_y(ui_Label_Cancel, -17);
