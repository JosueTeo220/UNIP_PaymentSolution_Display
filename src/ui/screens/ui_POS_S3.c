...
void ui_POS_S3_screen_init(void)
{
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_3, -2);
    lv_obj_set_y(ui_IMG_S2_Bg_3, -27);
    ...
    lv_obj_set_x(ui_IMG_S2_Bg_4, -1);
    lv_obj_set_y(ui_IMG_S2_Bg_4, 50);
    ...
    lv_obj_set_height(ui_Container1, 224);
    ...
    lv_obj_set_y(ui_Panel_List_BTC, 1);
    ...
    lv_obj_set_y(ui_Panel_List_XRP, 170);
    ...
    lv_obj_set_y(ui_Panel_List_Card, 250);
